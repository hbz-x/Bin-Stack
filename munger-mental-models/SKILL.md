...
description: "Charlie Munger multidisciplinary mental-model analysis: use inversion, circle of competence, margin of safety, incentives, psychology of human misjudgment, and cross-disciplinary latticework to stress-test decisions, investment theses, business problems, product strategy, career choices, or personal plans. Use when the user says \"芒格\", \"多元思维模型\", \"普世智慧\", \"反过来想\", \"逆向思维\", \"能力圈\", \"误判心理学\", \"Lollapalooza\", \"mental models\", \"Munger\", \"worldly wisdom\", \"invert\", or asks to use Munger-style thinking/checklists. For individual stock / company evaluation, prefer the investment-checklist skill; for wealth-building paths, status games, or happiness/desire management, prefer the naval-wealth-happiness skill; use this skill for broader decisions or when the user explicitly asks for Munger-style thinking on an investment thesis. Do NOT use for quick factual answers, technical debugging, market timing, chart analysis, or when the user wants a direct answer without a decision framework."
---
